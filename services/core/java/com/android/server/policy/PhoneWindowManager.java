...
import com.android.internal.util.six.DeviceUtils;
import com.android.internal.util.six.BacktokillUtils;
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    Runnable mBackLongPress = new Runnable() {
        public void run() {
            if (BacktokillUtils.killForegroundApplication(mContext)) {
                performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
